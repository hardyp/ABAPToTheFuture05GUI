...
*--------------------------------------------------------------------*
* Listing 04.04:  Test Injections for Test Seams
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
  METHOD fire_nuclear_missile."Automated Unit Test Method
    TEST-INJECTION read_database.
* Set assorted variables, just as if you had read them from the
* actual database
    END-TEST-INJECTION.

    TEST-INJECTION missile_sensor.
      "Production statements replaced with empty code
    END-TEST-INJECTION.
    ...
    TEST-INJECTION missile_launch.
      "Production statements replaced with empty code
    END-TEST-INJECTION.

    TEST-INJECTION printer.
      "Production statements replaced with empty code
    END-TEST-INJECTION.

    PERFORM fire_nuclear_missile.

* Do some sort of check that the business logic worked
